...
export class EOAExecutor {
    ...
    async respondToHandshake(inResponseTo, ciphertext) {
...
export class UserOpExecutor {
    ...
    async respondToHandshake(inResponseTo, ciphertext) {
        const logChainCallData = this.logChainInterface.encodeFunctionData("respondToHandshake", [inResponseTo, ciphertext]);
        const smartAccountCallData = this.smartAccountInterface.encodeFunctionData("execute", [
            this.logChainAddress,
            0, // value
            logChainCallData,
